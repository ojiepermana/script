...
apk add php php-cli  php-common php-pcntl  php-session  php-xml  php-sodium  php-tokenizer  php-fileinfo  php-dom  php-simplexml  php-xmlwriter  php-mysqli php-posix  php-pdo_mysql  php-json  php-openssl  php-curl  php-ctype  php-zlib  php-phar  php-session  php-mbstring  php-gd php-sockets php83-dev  php-pear
apk add composer 
...
sh -c 'echo "extension=openswoole.so" > /etc/php83/conf.d/09_openswoole.ini'
